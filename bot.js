...
function respond() {
  var request = JSON.parse(this.req.chunks[0]),
      ...
      botRegexSiege = /^\/siege/; botRegexOW = /^\/4th/; 
      botRegexSlut = /^\/slut/; botRegexStop = /^\/stop/;
      botRegexProp = /^\/westbrook/;botRegexKys = /^\/kys/; botRegexSlam = /^\/slam/; botRegexBrye = /^\/brye/;
  ...
  if(request.text && botRegex.test(request.text)) {
    ...
    postMessage("http://daddyleagues.com/rftr/team/"+request.text.substring(5,8)+"/schedule");
    this.res.end();
  }
    ...
    var rep = req.replace(/ /,"+");
    postMessage("http://daddyleagues.com/rftr/players?name="+rep+"&position=all&team=all");
